...
var bucksdaemonServiceRPC = function (opts) {
  opts = opts || {};
  if (!(this instanceof bucksdaemonServiceRPC)) return new bucksdaemonServiceRPC(opts);
...
bucksdaemonServiceRPC.prototype.reset = function (opts) {
...
bucksdaemonServiceRPC.prototype.save = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype.getViewKey = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype.getSpendKeys = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
bucksdaemonServiceRPC.prototype.getStatus = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype.createAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.deleteAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
bucksdaemonServiceRPC.prototype.getBalance = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
bucksdaemonServiceRPC.prototype.getBlockHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
    opts.blockHash = opts.blockHash || false
...
bucksdaemonServiceRPC.prototype.getUnconfirmedTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
...
bucksdaemonServiceRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.newTransfer = function (address, amount) {
  return {
    address: address,
...
bucksdaemonServiceRPC.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    var that = this
    opts = opts || {}
    opts.addresses = opts.addresses = []
...
bucksdaemonServiceRPC.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses = []
    opts.transfers = opts.transfers || false
...
bucksdaemonServiceRPC.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype.deleteDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.sendDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.transactionHash = opts.transactionHash || false
...
bucksdaemonServiceRPC.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.threshold = opts.threshold || this.defaultFusionThreshold
    opts.addresses = opts.addresses || []
...
bucksdaemonServiceRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonServiceRPC.prototype.getFeeInfo = function () {
  return this.getNodeFeeInfo()
}

bucksdaemonServiceRPC.prototype.getNodeFeeInfo = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonServiceRPC.prototype._postToWalletd = function (method, params) {
  return new Promise((resolve, reject) => {
...
module.exports = bucksdaemonServiceRPC