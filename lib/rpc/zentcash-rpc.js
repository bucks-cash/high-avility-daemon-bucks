...
var bucksdaemonRPC = function (opts) {
  opts = opts || {};
  if (!(this instanceof bucksdaemonRPC)) return new bucksdaemonRPC(opts);
  this.host = opts.host || '127.0.0.1';
  this.port = opts.port || 21698;
  this.timeout = opts.timeout || 2000;
  this.ssl = true;
}

bucksdaemonRPC.prototype.getBlocks = function (opts) {
...
bucksdaemonRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {};
...
bucksdaemonRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
bucksdaemonRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
bucksdaemonRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
bucksdaemonRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
bucksdaemonRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getHeight = function () {
  return this.height()
}

bucksdaemonRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getInfo = function () {
  return this.info()
}

bucksdaemonRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.feeInfo = function () {
  return this.fee()
}

bucksdaemonRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getPeers = function () {
  return this.peers()
}

bucksdaemonRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getBlocks = function (opts) { // getblocks
...
bucksdaemonRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
bucksdaemonRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
bucksdaemonRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
bucksdaemonRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
bucksdaemonRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bucksdaemonRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
bucksdaemonRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
bucksdaemonRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
